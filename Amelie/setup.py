...
setup(name = "AmelieBot",version = "2.5.2", description = "Chat bot with the ability to perform some functions", executables = [exe], options = dict(build_exe = buildOptions))
