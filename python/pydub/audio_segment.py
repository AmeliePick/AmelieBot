...
import os
import subprocess
CREATE_NO_WINDOW = 0x08000000 # To hide console on Windows.
from tempfile import TemporaryFile, NamedTemporaryFile
import wave
import sys
import struct
from .logging_utils import log_conversion, log_subprocess_output
from .utils import fsdecode
import base64
...
class AudioSegment(object):
    ...
    # Note by AmeliePick.
    # get_encoder_name, get_player_name, get_prober_name, which - these function doesn't correct work
    # if ffmpeg codes is in custom disposition.
    #
    # To change location of the encoder you need to use "ffmpeg" setter wit path to the encoder.
    # the path can be absolute or relative.
    #
    # To change the probe or/and the player you need to edit that code manually.
    ...
    def from_file(cls, file, format=None, codec=None, parameters=None, **kwargs):
        ...
        # Remove getting file info.
        # bit per sample is 16 for 'mp3', 'mp4', 'aac', 'webm', 'ogg'.
        # Edited by AmeliePick.
